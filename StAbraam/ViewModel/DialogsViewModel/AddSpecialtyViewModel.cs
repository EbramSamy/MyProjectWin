...
{
    class AddSpecialtyViewModel : ViewModelBase, IDataErrorInfo
    {
        #region validations
        public string this[string columnName]
        {
            get
            {
                if (columnName == "SpecialtyName" && (string.IsNullOrWhiteSpace(SpecialtyName)))
                {
                    IsValid = false;
                    return "Specialty Name Can't Be Empty";
                }
